...
# Profundidades objetivo por estación
station_depths = {
    'GS23': [0.5, 10, 25, 50, 100, 200],
    'GS26': [0.5, 10, 25, 50, 100, 200],
    'GS29': [0.5, 10, 25, 50, 100, 200, 400],
    'GS34': [0.5, 10, 25, 50, 100, 200]
}

# Estaciones a procesar
stations = ['GS23', 'GS26', 'GS29', 'GS34']
...
for station in stations:
    ...
    # Usar las profundidades específicas para cada estación
    for target in station_depths[station]:
    ...
    # Determinar el límite de profundidad según la estación
    depth_limit = 420 if station == 'GS29' else 220
